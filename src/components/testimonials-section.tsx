...
export function TestimonialsSection({ content }: TestimonialsSectionProps) {
  return (
    <section
      ...
      className="overflow-x-clip bg-background-01 px-[1.25rem] w-full py-[1.25rem] tablet:py-[5rem] text-text-01 tablet:px-[2.5rem] tablet:py-[2.5rem] desktop:py-[2.5rem]"
    >
      <div className="mx-auto grid w-full grid-cols-[minmax(0,1fr)] items-center gap-[5rem] desktop:grid-cols-[minmax(0,25rem)_minmax(0,31.25rem)] desktop:justify-between desktop:gap-[7.5rem]">
